...
namespace Kugar.Core.BaseStruct
{
    ...
    /// </summary>
    public class WrapObject : DynamicObject, ITypedList, ICustomTypeDescriptor
    {
        ...
        public WrapObject(object sourceObj, string[] partialPropertyNames)
        {
    ...
    /// </summary>
    internal class WrapPropertyCastObject : WrapObject
    {
    ...
    public static class PartialObjectExtMethod
    {
        ...
        /// <returns></returns>
        public static WrapObject ToPartialObject(this object sourceObj, string[] partialPropertyNames)
        {
            return new WrapObject(sourceObj, partialPropertyNames);
        }
        ...
        /// <returns></returns>
        public static WrapObject ToPartialObject<T>(this T sourceObj,params Expression<Func<T, object>>[] partialPropertyNames)
        {
            //var names =
        ...
        /// <returns></returns>
        public static WrapObject ToWrapObject(this object sourceObj, WrapObjectPropertyCast[] castLst)
        {
        ...
        /// <param name="castLst">属性转换列表</param>
        /// <returns></returns>
        public static WrapObject ToWrapObject(this object sourceObj, string[] partialPropertyNames,
